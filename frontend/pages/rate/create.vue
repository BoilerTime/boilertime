                ...
                <form @submit.prevent="() => createreview()">
                    <div class="gap-8 columns-2">
                        ...
                        <label for="reviewtype"
                            class="pt-5 block mb-2 text-sm font-medium text-gray-900 dark:text-black">What would
                        ...
                        <label for="reviewselection"
                            class="pt-5 block mb-2 text-sm font-medium text-gray-900 dark:text-black">What
                    ...
                    <div v-if="reviewtype === 'course' && reviewselection !== 'null'">
                        ...
                        <label for="rating1" class="pt-5 block mb-2 text-sm font-medium text-gray-900 dark:text-black">How
                            strict are the prerequisite requirements?</label>
                        ...
                        <label for="rating2" class="pt-5 block mb-2 text-sm font-medium text-gray-900 dark:text-black">How
                            is the pace of materials covered?</label>
                        <span class="text-sm items-center">2.5</span>
                        ...
                        <label for="rating3" class="pt-5 block mb-2 text-sm font-medium text-gray-900 dark:text-black">How
                            in-depth is the material?</label>
                        <span class="text-sm items-center">2.5</span>
                    ...
                    <div v-else-if="reviewtype === 'classroom'">
                        ...
                        <label for="rating1" class="pt-5 block mb-2 text-sm font-medium text-gray-900 dark:text-black">How
                            convenient is it to access this classroom?</label>
                        <span class="text-sm items-center">2.5</span>
                        <input id="rating1" type="range" min="0" max="5" step="0.5"
                            class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700"
                            oninput="this.previousElementSibling.innerText=this.value" v-model="rating1">
                        ...
                        <label for="rating2" class="pt-5 block mb-2 text-sm font-medium text-gray-900 dark:text-black">What
                            is the quality of seating?</label>
                        <span class="text-sm items-center">2.5</span>
                        <input id="rating2" type="range" min="0" max="5" step="0.5"
                            class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700"
                            oninput="this.previousElementSibling.innerText=this.value" v-model="rating2">
                        ...
                        <label for="rating3" class="pt-5 block mb-2 text-sm font-medium text-gray-900 dark:text-black">What
                            is the availability of technology?</label>
                        <span class="text-sm items-center">2.5</span>
                        <input id="rating3" type="range" min="0" max="5" step="0.5"
                            class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700"
                            oninput="this.previousElementSibling.innerText=this.value" v-model="rating3">
