  ...
  <div class="h-screen bg-gradient-to-b from-gray-100 to-gray-300">
    ...
    <div class="mx-auto w-5/12 p-3 bg-white border rounded-lg shadow sm:p-7 md:p-8 dark:bg-white">
      ...
      <form @submit.prevent="() => signup()">
        ...
        <div class="gap-8 columns-2">
          <!--Graduation month-->
          <label for="gradmonth" class="pt-5 block mb-2 text-sm font-medium text-gray-900 dark:text-black">Graduation Month</label>
          <select id="gradmonth" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full
          ...
          <!--Graduation year-->
          <label for="gradyear" class="pt-5 block mb-2 text-sm font-medium text-gray-900 dark:text-black">Graduation Year</label>
          <select id="gradyear" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full
            p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <label for="gradstatus" class="pt-5 block mb-2 text-sm font-medium text-gray-900 dark:text-black">Student Status</label>
        <ul class="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
          <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
            <div class="flex items-center pl-3">
              <input id="isGradStudent" type="radio" value="false" name="isGradStudent" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600
              ...
              <label for="isGradStudent" class="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Undergraduate</label>
            </div>
          </li>
          <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
            <div class="flex items-center pl-3">
              <input id="isGradStudent" type="radio" value="true" name="isGradStudent" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600
                dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" v-model="isGradStudent" required>
              <label for="gradstatus" class="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Graduate</label>
            </div>
          </li>
        </ul>        
