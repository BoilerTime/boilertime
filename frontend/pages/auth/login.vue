<template>
  <section class="bg-white">
    <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
      ...
      >
        <img src="https://stories.purdue.edu/app/uploads/2022/07/TopBuildings-ContentHub-Hero.jpg" class="absolute inset-0 h-full w-full object-cover opacity-30">
      </aside>
      ...
      >
        <div class="max-w-xl lg:max-w-3xl">
          ...
          <p class="mt-4 leading-relaxed text-gray-500">
            Don't have an account? <a href="/auth/signup" class="text-yellow-500">Sign up here →</a>
          </p>
          ...
          <form @submit.prevent="() => login()">
            ...
            <input type="email" id="email" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
              focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 dark:bg-gray-300 dark:placeholder-black dark:text-black dark:focus:ring-yellow-500"
            ...
            <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
              <button type="submit" class="inline-block shrink-0 bg-black hover:bg-gray-800 text-white font-bold py-2 px-10 mt-5 rounded">
                Log in
              </button>

              <p class="mt-5 text-sm text-gray-500">
                <a href="#" class="text-gray-700 underline">Forgot password?</a>
              </p>
            </div>
