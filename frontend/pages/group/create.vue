  ...
  <div class="h-screen p-16 dark:bg-neutral-500 bg-gray-200">
    ...
    >
      ...
      <form @submit.prevent="() => creategroup()">
        <label
          for="name"
          class="pt-3 block mb-2 text-2x1 font-medium text-gray-900 dark:text-gray-200"
        >
          Group Name
        </label>
        <input
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <h1
            class="pt-3 block mb-2 text-2x1 font-medium text-gray-900 dark:text-black text-center"
          >
