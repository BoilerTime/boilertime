<template>
  <main>
    ...
    <div class="flex flex-col items-center mt-12">
      <h1 class="mb-6 text-2xl font-bold text-center">Aggregated reviews for your <br>professor, classroom, course, and TA
      </h1>
          ...
          <div v-for="(group, index) in resultData" :key="index">
            <div v-for="(rating, ratingIndex) in group" :key="ratingIndex"
              ...
              <div class="flex items-center">
                <span class="mr-2 font-bold text-gray-700">Flagged:</span>
