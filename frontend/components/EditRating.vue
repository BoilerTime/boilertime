            ...
            <DialogPanel class="text-left bg-white dark:bg-neutral-700 p-6 rounded-lg">
              ...
              <div class="mt-2">
                <form>
                  ...
                  <input type="text" class="bg-gray-200 dark:bg-neutral-500 dark:text-gray-200 hover:outline-none focus:outline-none p-1 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" v-model="q1_edit"><br>
                  <label class="mt-1 mb-1 dark:text-gray-200">Second rating: {{ q2 }}</label><br>
                  <input type="text" class="bg-gray-200 dark:bg-neutral-500 dark:text-gray-200 hover:outline-none focus:outline-none p-1 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" v-model="q2_edit"><br>
                  <label class="mb-1 dark:text-gray-200">Third rating: {{ q3 }}</label><br>
                  <input type="text" class="bg-gray-200 dark:bg-neutral-500 dark:text-gray-200 hover:outline-none focus:outline-none p-1 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" v-model="q3_edit"><br>
                </form>
              </div>
